...
trait Locs {
  private lazy val userMeta      = SquerylAuth.authUserMeta.vend

  private lazy val indexUrl      = SquerylAuth.indexUrl.vend
  private lazy val loginUrl      = SquerylAuth.loginUrl.vend
  private lazy val logoutUrl     = SquerylAuth.logoutUrl.vend
