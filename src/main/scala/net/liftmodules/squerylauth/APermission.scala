...
object APermission {
  lazy val wildcardToken  = SquerylAuth.permissionWilcardToken.vend
  lazy val partDivider    = SquerylAuth.permissionPartDivider.vend
  lazy val subpartDivider = SquerylAuth.permissionSubpartDivider.vend
